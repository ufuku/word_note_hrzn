...
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."  # Key'i buraya yaz
# 👆 BURAYA KENDI BİLGİLERİNİ YAZ
...
# Vercel/Gunicorn için app'i dışa aktar
# (Bu satır olmadan Vercel app'i bulamaz)
# app objesini Vercel kullanacak
